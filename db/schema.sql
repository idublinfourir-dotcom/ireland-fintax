...
-- `change-me@example.com` is a placeholder: replace it with this deployment's
-- admin address before applying, or no account can ever reach /admin. Existing
-- accounts instead need:
...
begin
  ...
  values (
    ...
    case when lower(new.email) = 'change-me@example.com'
